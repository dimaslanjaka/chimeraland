...
export class ReactSEOMetaTags extends React.PureComponent<ReactSEOMetaTagsProps> {
  ...
  renderGeneral({
    ...
    description,
    image
  }: CombinedProps<Record<string, any>>) {
    return [
  ...
  renderFacebook(props: CombinedProps<FacebookProps>) {
    ...
    return [
      ...
      <meta property="og:locale" content={language} key="og:local" />,
  ...
  renderBlogPostSEO(props: ReactSEOMetaTagsProps) {
    ...
    return [
      ...
      <script
        key="renderBlogPostSEO-application/ld+json"
  ...
  renderWebsiteSEO(props: ReactSEOMetaTagsProps) {
    ...
    return [
      ...
      <script
        key="renderWebsiteSEO-application/ld+json"
        type="application/ld+json">
        {
          /**
